...
function loadReports() {
    ...
    $.ajax({
        url: '/eyecore/api/payroll-reports.php',
        type: 'GET',
        data: params,
        dataType: 'json',
...
function loadStats() {
    $.ajax({
        url: '/eyecore/api/payroll-reports.php?action=get_stats',
        type: 'GET',
        dataType: 'json',
        success: function(response) {
            if (response.success) {
...
function loadChartData() {
    ...
    $.ajax({
        url: `/eyecore/api/payroll-reports.php?action=get_chart_data&year=${year}`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
            if (response.success) {
...
function loadPendingApprovals() {
    $.ajax({
        url: '/eyecore/api/payroll-reports.php?action=get_reports&type=Generated&limit=3',
        type: 'GET',
        dataType: 'json',
        success: function(response) {
...
function viewReportDetails(id) {
    ...
    $.ajax({
        url: `/eyecore/api/payroll-reports.php?action=get_report_details&id=${id}`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
...
function downloadReport(id, format = 'PDF') {
    Swal.fire({
        ...
        didOpen: () => {
            ...
            $.ajax({
                url: `/eyecore/api/payroll-reports.php?action=download_report&id=${id}&format=${format}`,
                type: 'GET',
                dataType: 'json',
                success: function(response) {
                    Swal.close();
...
function confirmExportAll() {
    ...
    Swal.fire({
        ...
        didOpen: () => {
            ...
            $.ajax({
                url: `/eyecore/api/payroll-reports.php?action=export_all&period=${period}&format=${format}`,
                type: 'GET',
                dataType: 'json',
                success: function(response) {
                    Swal.close();
